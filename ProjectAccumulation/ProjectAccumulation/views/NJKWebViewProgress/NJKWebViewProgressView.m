...
//    UIColor *tintColor = [UIColor colorWithRed:22.f / 255.f green:126.f / 255.f blue:251.f / 255.f alpha:1.0];
    UIColor *tintColor = [UIColor colorWithRed:51.f / 255.f green:166.f / 255.f blue:251.f / 255.f alpha:1.0];
//  UIColor *tintColor = [UIColor colorWithRed:255.f / 255.f green:208.f / 255.f blue:44.f / 255.f alpha:1.0]; // iOS7 Safari bar color
